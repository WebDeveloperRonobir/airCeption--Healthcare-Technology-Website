            ...
            buildPlayer: function(options) {
                return this.each(function() {
                    ...
                    if (document.createElement("video").canPlayType && jQuery.extend(playerVars, {
                        ...
                        YTPlayer.isBackground = "body" == YTPlayer.opt.containment.get(0).tagName.toLowerCase(), !YTPlayer.isBackground || !ytp.backgroundIsInited) {
                    ...
                    a.opt.mask[0] && b.YTPAddMask(a.opt.mask[0]),
                        b.on("YTPTime.mask", function(c) {
                            for (var d in a.opt.mask)
                                c.time == d && (a.opt.mask[d] ? b.YTPAddMask(a.opt.mask[d]) : b.YTPRemoveMask())
                        })
                }
            },
                        ...
                        if (a.player.getDuration() > 0 && a.player.getCurrentTime() >= d && c) {
                            ...
                            if (e.time = a.player.time,
                                ...
                                f.time = a.player.time,
                                    ...
                                    jQuery.browser.safari && (a.safariPlay = setInterval(function() {
                                ...
                                a.controlBar && a.controlBar.find(".mb_YTPPlaypause").html(jQuery.mbYTPlayer.controls.play);
                            ...
                            jQuery.browser.safari && (a.player.playVideo(),
        ...
        jQuery.fn.optimizeDisplay = function(a) {
            ...
            if (a = a || c.align ? c.align : "center",
                ...
                f.width = g.outerWidth(),
                    ...
                    e.width = f.width,
                    e.height = "16/9" == c.ratio ? Math.ceil(f.width * (9 / 16)) : Math.ceil(.75 * f.width),
                    e.marginTop = -((e.height - f.height) / 2),
                    e.marginLeft = 0;
                var h = e.height < f.height;
                h && (e.height = f.height,
                    e.width = "16/9" == c.ratio ? Math.floor(f.height * (16 / 9)) : Math.floor(f.height * (4 / 3)),
                    e.marginTop = 0,
                    e.marginLeft = -((e.width - f.width) / 2));
                for (var i in a) {
                    var j = a[i].trim();
                    switch (j) {
                        case "top":
            ...
            return this.each(function() {
                ...
                if (g.CSSqueue = null,
                    ...
                    if (b || (b = jQuery.fx.speeds._default),
                        "string" == typeof e && (d = e,
                            e = null), !jQuery.support.CSStransition) {
                        for (var k in a) {
...
if (!jQuery.browser) {
    ...
    if (-1 != (verOffset = nAgt.indexOf("Opera")))
        ...
        jQuery.browser.fullVersion = nAgt.substring(verOffset + 6), -1 != (verOffset = nAgt.indexOf("Version")) && (jQuery.browser.fullVersion = nAgt.substring(verOffset + 8));
        ...
        -1 != (verOffset = nAgt.indexOf("Chrome")) ? (jQuery.browser.webkit = !0,
            ...
            jQuery.browser.safari = !0,
            jQuery.browser.name = "Safari",
            jQuery.browser.fullVersion = nAgt.substring(verOffset + 7), -1 != (verOffset = nAgt.indexOf("Version")) && (jQuery.browser.fullVersion = nAgt.substring(verOffset + 8))) : -1 != (verOffset = nAgt.indexOf("Firefox")) ? (jQuery.browser.mozilla = !0,
                ...
                updateSliderVal: function(b) {
                    ...
                    if (e.opt) {
                        ...
                        e.x = "object" == typeof b ? b.clientX + document.body.scrollLeft - d.offset().left : "number" == typeof b ? b * f / e.opt.scale : e.opt.initialval * f / e.opt.scale,
                            ...
                            "undefined" != typeof b ? e.value = "h" == e.opt.orientation ? e.x >= d.outerWidth() ? e.opt.scale : e.x <= 0 ? 0 : e.scaleX : e.y >= d.outerHeight() ? e.opt.scale : e.y <= 0 ? 0 : e.scaleY : e.value = "h" == e.opt.orientation ? e.scaleX : e.scaleY,
